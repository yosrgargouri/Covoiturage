...
//        holder.telephone.setText(offre.getTelephone().toString());
        holder.adresseDestination.setText(offre.getAdresse_destination());
        holder.adresseDepart.setText(offre.getAdresse_depart());
        holder.heureDepart.setText(offre.getHeure_depart());
//        holder.nombrePlace.setText(offre.getNombrePlace().toString());
